...
set :rails_env, "mrt-storeAudit04-prd"

puts "----- mrt-storeAudit04-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-storeAudit04-prd"
...
server "audit04-aws.cdlib.org", user: "dpr2", roles: %w{web app}
