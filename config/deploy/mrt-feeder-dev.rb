...
set :rails_env, "mrt-feeder-dev"

puts "----- mrt-feeder-dev branch of https://hg.cdlib.org/tomcat8_catalina_base -----"
set :repo_url, "https://hg.cdlib.org/tomcat8_catalina_base"
set :branch, "mrt-feeder-dev"

set :application, "merritt-feeder"
set :build_url, "http://builds.cdlib.org/job/mrt-feeder%20(default)/lastSuccessfulBuild/artifact/feedermets-war/aws-dev/feeder-mets.aws-dev.war"
