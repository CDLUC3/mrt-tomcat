...
set :rails_env, "mrt-ingest01-prd"

puts "----- mrt-ingest01-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-ingest01-prd"
...
server "uc3-ingest01-prd", user: "dpr2", roles: %w{web app}
