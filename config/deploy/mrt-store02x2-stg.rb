...
set :rails_env, "mrt-store02x2-stg"

puts "----- mrt-store02x2-stg branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-store02x2-stg"
...
server "uc3-mrtstore02x2-stg.cdlib.org", user: "dpr2store", roles: %w{web app}
