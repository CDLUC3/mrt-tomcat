...
set :rails_env, "uc3-mrt-access-prd"

puts "----- uc3-mrt-access-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "uc3-mrt-access-prd"

set :application, "merritt-store"
set :semantic_version, ENV['MERRITT_ACCESS_RELEASE'] || 'undefined'
