...
set :rails_env, "mrt-ingest03x2-prd"

puts "----- mrt-ingest03x2-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-ingest03x2-prd"
...
server "uc3-ingest03x2-prd", user: "dpr2", roles: %w{web app}
