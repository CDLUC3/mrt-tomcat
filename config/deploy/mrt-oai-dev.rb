...
puts "----- mrt-oai-stg branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-oai-stg"

set :application, "merritt-oai"
set :build_url, "http://builds.cdlib.org/view/Merritt/job/mrt-build-oai/ws/oai-war/war/dev/mrtoai.war"
...
server "uc3-mrtoai-dev", user: "dpr2", roles: %w{web app}
