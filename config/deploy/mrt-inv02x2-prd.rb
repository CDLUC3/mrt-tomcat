...
set :rails_env, "mrt-inv02x2-prd"

puts "----- mrt-inv02x2-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-inv02x2-prd"
...
server "uc3-mrtinv02x2-prd.cdlib.org", user: "dpr2", roles: %w{web app}
