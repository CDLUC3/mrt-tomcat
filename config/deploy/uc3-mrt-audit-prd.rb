...
set :rails_env, "uc3-mrt-audit-prd"
set :semantic_version, ENV['MERRITT_AUDIT_RELEASE'] || 'undefined'
puts "----- uc3-mrt-autid-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "uc3-mrt-audit-prd"
