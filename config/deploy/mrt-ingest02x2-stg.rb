...
set :rails_env, "mrt-ingest02x2-stg"

puts "----- mrt-ingest02x2-stg branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-ingest02x2-stg"
...
server "uc3-ingest02x2-stg", user: "dpr2", roles: %w{web app}
