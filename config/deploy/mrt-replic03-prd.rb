...
set :rails_env, "mrt-replic03-prd"

puts "----- mrt-replic03-prd branch of https://hg.cdlib.org/tomcat8_catalina_base -----"
set :repo_url, "https://hg.cdlib.org/tomcat8_catalina_base"
set :branch, "mrt-replic03-prd"
...
server "replic03-aws.cdlib.org", user: "dpr2", roles: %w{web app}
