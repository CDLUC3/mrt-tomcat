...
set :rails_env, "mrt-inv01x2-prd"

puts "----- mrt-inv01x2-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-inv01x2-prd"
...
server "uc3-mrtinv01x2-prd.cdlib.org", user: "dpr2", roles: %w{web app}
