...
puts "----- mrt-audit-dev branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
...
set :build_url, "http://builds.cdlib.org/view/Merritt/job/mrt-build-audit/ws/audit-war/war/dev/mrtaudit.war"
