...
set :rails_env, "mrt-ingest02x2-prd"

puts "----- mrt-ingest02x2-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
...
server "uc3-ingest02x2-prd", user: "dpr2", roles: %w{web app}
