...
set :rails_env, "mrt-node-stg"

puts "----- mrt-node-stg branch of https://hg.cdlib.org/tomcat8_catalina_base -----"
set :repo_url, "https://hg.cdlib.org/tomcat8_catalina_base"
set :branch, "mrt-node-stg"

set :application, "merritt-node"
# Do not define, Capistrano will prompt at build time
set :build_url, "http://builds.cdlib.org/view/Merritt/job/mrt-node%20(default)/ws/node-war-uc3/node-8001-stg/mrt-node.node-8001-stg.war"
...
server "replic01-aws-stg.cdlib.org", user: "dpr2", roles: %w{web app}
