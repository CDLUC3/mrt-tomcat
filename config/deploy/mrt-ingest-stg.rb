...
set :rails_env, "mrt-ingest-stg"
set :semantic_version, ENV['MERRITT_INGEST_RELEASE'] || 'undefined'
puts "----- mrt-ingest-stg branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-ingest-stg"

set :application, "merritt-ingest"
set :build_url, "http://builds.cdlib.org/userContent/mrt-audit/mrt-ingest-#{fetch(:semantic_version)}.war"
