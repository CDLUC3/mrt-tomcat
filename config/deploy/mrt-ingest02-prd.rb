...
set :rails_env, "mrt-ingest02-prd"

puts "----- mrt-ingest02-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-ingest02-prd"
...
server "uc3-ingest02-prd", user: "dpr2", roles: %w{web app}
