...
set :rails_env, "mrt-replic03x2-prd"

puts "----- mrt-replic03x2-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-replic03x2-prd"
...
server "uc3-mrtreplic03x2-prd.cdlib.org", user: "dpr2", roles: %w{web app}
