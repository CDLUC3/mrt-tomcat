...
set :rails_env, "mrt-replic05-prd"

puts "----- mrt-replic05-prd branch of https://hg.cdlib.org/tomcat8_catalina_base -----"
set :repo_url, "https://hg.cdlib.org/tomcat8_catalina_base"
set :branch, "mrt-replic05-prd"
...
server "replic05-aws.cdlib.org", user: "dpr2", roles: %w{web app}
