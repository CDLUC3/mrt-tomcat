...
set :rails_env, "mrt-store01x2-prd"

puts "----- mrt-store01x2-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-store01x2-prd"
...
server "uc3-mrtstore01x2-prd.cdlib.org", user: "dpr2store", roles: %w{web app mrtHomes}
