...
set :rails_env, "mrt-dataone-stg"

puts "----- mrt-dataone-stg branch of https://hg.cdlib.org/tomcat8_catalina_base -----"
set :repo_url, "https://hg.cdlib.org/tomcat8_catalina_base"
set :branch, "mrt-dataone-stg"

set :application, "merritt-dataone"
set :build_url, "http://builds.cdlib.org/job/mrt-metacat-stage/lastSuccessfulBuild/artifact/dist/knb.war"
set :target, "knb.war"
...
server "dataone-aws-stg.cdlib.org", user: "dataone", roles: %w{web app}
