...
set :rails_env, "uc3-mrt-store-stg"

puts "----- uc3-mrt-store-stg branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "uc3-mrt-store-stg"

set :application, "merritt-store"
set :semantic_version, ENV['MERRITT_STORAGE_RELEASE'] || 'undefined'
