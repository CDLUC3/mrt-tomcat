...
set :rails_env, "mrt-replic04-prd"

puts "----- mrt-replic04-prd branch of https://hg.cdlib.org/tomcat8_catalina_base -----"
set :repo_url, "https://hg.cdlib.org/tomcat8_catalina_base"
set :branch, "mrt-replic04-prd"
...
server "replic04-aws.cdlib.org", user: "dpr2", roles: %w{web app}
