...
set :rails_env, "mrt-audit02x2-stg"

puts "----- mrt-audit02x2-stg branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-audit02x2-stg"

set :application, "merritt-audit"
set :build_url, "http://builds.cdlib.org/view/Merritt/job/mrt-build-audit/ws/audit-war/war/stage/mrtaudit.war"
...
server "uc3-mrtaudit02x2-stg", user: "dpr2", roles: %w{web app}
