...
puts "----- mrt-store-dev branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
...
set :build_url,   "http://builds.cdlib.org/view/Merritt/job/mrt-store-pub/ws/store-war/war/dev/storage.war"
