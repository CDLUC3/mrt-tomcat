...
set :rails_env, "mrt-storeAudit02-prd"

puts "----- mrt-storeAudit02-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-storeAudit02-prd"
...
server "audit02-aws.cdlib.org", user: "dpr2", roles: %w{web app}
