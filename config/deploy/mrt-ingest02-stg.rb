...
set :rails_env, "mrt-ingest02-stg"

puts "----- mrt-ingest02-stg branch of https://hg.cdlib.org/tomcat8_catalina_base -----"
set :repo_url, "https://hg.cdlib.org/tomcat8_catalina_base"
set :branch, "mrt-ingest02-stg"
...
server "uc3-ingest02-stg", user: "dpr2", roles: %w{web app}

# custom
set :ingestqueue, "/dpr2scratch/ingest_home/queue"
