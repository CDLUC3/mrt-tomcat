...
set :rails_env, "mrt-storeAudit01-prd"

puts "----- mrt-storeAudit01-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-storeAudit01-prd"
...
server "audit01-aws.cdlib.org", user: "dpr2", roles: %w{web app}
