...
set :rails_env, "mrt-replic01x2-prd"

puts "----- mrt-replic01x2-prd branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-replic01x2-prd"

set :application, "merritt-replic"
# Do not define, Capistrano will prompt at build time
set :build_url, "http://builds.cdlib.org/view/Merritt/job/mrt-build-replic/ws/replication-war/war/proprodd/mrtreplic.war" 
...
server "uc3-mrtreplic01x2-prd.cdlib.org", user: "dpr2", roles: %w{web app}
