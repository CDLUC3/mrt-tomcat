...
set :rails_env, "mrt-replic02x2-stg"

puts "----- mrt-replic02x2-stg branch of https://github.com/CDLUC3/tomcat8_catalina_base -----"
set :repo_url, "https://github.com/CDLUC3/tomcat8_catalina_base"
set :branch, "mrt-replic02x2-stg"
...
server "uc3-mrtreplic02x2-stg.cdlib.org", user: "dpr2", roles: %w{web app}
